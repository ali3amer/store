<template>
    <div>
        ...
        <!--            <not-found></not-found>-->
        <!--        </div>-->
        <div v-if="'read_expenses' in allPermissions" class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="card-tools text-right">
                            <button v-if="'create_expenses' in allPermissions" class="btn btn-primary" data-toggle="modal" @click="newModal()"
            ...
            <div class="card-body table-responsive p-0">
                <table class="table table-bordered table-hover">
                    ...
                    <tr v-for="(row, index) in rows.data" :key="row.id">
                        ...
                        <td>
                            <a v-if="'update_expenses' in allPermissions" href="#" :data-target="'#' + modalTitle" @click="editModal(row)"><i
                                class="fa fa-edit blue"></i></a> / <a v-if="'delete_expenses' in allPermissions" href="#" @click="deleteData(row.id)"><i
                ...
                <div class="modal-content">
                    <form @submit.prevent="editMode ? updateData() : createData()">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <input v-model="form.price" type="text" name="price" placeholder="المبلغ"
    ...
    methods: {
        ...
        searchResults() {
            if (this.searchExpense != '') {
                axios.get('api/' + this.routeName + '?name=' + this.searchExpense).then(({data}) => (this.rows = data));
            } else if (this.searchExpense == '') {
